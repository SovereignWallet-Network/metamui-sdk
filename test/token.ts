...
describe('Token works correctly', () => {
  ...
  if (constants.providerNetwork == 'local') {
    ...
    it('Mint Token VC is stored correctly', async () => {
      ...
      let vcHex = await vc.generateVC(vc_property, owner, issuers, VCType.MintTokens, signKeypairDave);
    ...
    it('Transfer Token VC works created correctly', async () => {
      ...
      let vcHex = await vc.generateVC(vc_property, owner, issuers, VCType.TokenTransferVC, signKeypairDave);
      let txn = await vc.storeVC(vcHex, sigKeypairValidator, provider);
    ...
    it('Slash Token VC works created correctly', async () => {
      ...
      let vcHex = await vc.generateVC(vc_property, owner, issuers, VCType.SlashTokens, signKeypairDave);
      let txn = await vc.storeVC(vcHex, sigKeypairValidator, provider);
